...
import (
	...
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/artifact"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/auditlog"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/configure"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/gc"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/health"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/icon"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/immutable"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/jobservice"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/label"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/ldap"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/member"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/oidc"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/permissions"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/ping"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/preheat"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/project"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/project_metadata"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/purge"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/quota"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/registry"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/replication"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/repository"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/retention"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/robot"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/robotv1"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/scan"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/scan_all"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/scan_data_export"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/scanner"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/schedule"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/search"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/securityhub"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/statistic"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/system_cve_allowlist"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/systeminfo"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/user"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/usergroup"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/webhook"
	"github.com/blackaichi/harbor-go-client/pkg/sdk/v2.0/client/webhookjob"
)
